...
fun AdventureScreen(viewModel: AdventureViewModel, navController: NavController) {
    ...
    LaunchedEffect(Unit) {
        val token = "eyJhbGciOiJIUzM4NCJ9.eyJzdWIiOiJzdHJpbmciLCJpYXQiOjE3MjY4NTU0MjgsImV4cCI6MTcyNzQ2MDIyOH0.Ix-oOZjaEP04tgIOizTJQeVyQ503NDq0iiTh8MG5I4bKVJsuPFDEqDwY-cSgNOqS"
